...
This homework is due by *11:59pm on Tuesday, 14 April 2026*. The initial
version of the design doc is due by *11:59pm on Friday, 10 April 2026*, and
you'll turn in that design doc on a separate assignment on Canvas.
...
those library functions (which we'll do very soon), then that would be still a
third C file -- which would contain its own `main` function, since it's a
...
[its page on
gitlab](https://git.ucsc.edu/cse-13s-spring-2026/cse-13s-resources-spring-2026).

This process will look like:

```
$ cd ~
$ git clone git@git.ucsc.edu:cse-13s-spring-2026/cse-13s-resources-spring-2026.git
$ cd ~/cse13s_sammytheslug/hw1/
$ cp ~/cse-13s-resources-spring-2026/hw1/hw1.c .
```
...
```
$ cd ~/cse13s_sammytheslug/hw1/
$ cp ~/cse-13s-resources-spring-2026/hw1/* .
```
...
git repository (and push!) by end-of-day on **Friday, 10 April 2026**. For
...
```
https://git.ucsc.edu/cse-13s-spring-2026/cse13s_sammytheslug/-/blob/main/hw1/DESIGN.md
```
...
here](https://git.ucsc.edu/cse-13s-spring-2026/demos-spring-2026/-/tree/main/count_lines)
and [also
here](https://git.ucsc.edu/cse-13s-spring-2026/demos-spring-2026/-/tree/main/characters).
